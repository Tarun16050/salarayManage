...
<div class="table_data_print tab-content " id="salary" >
    <div class="panel panel-primary">
        ...
        <div class="panel-body table-responsive">
            ...
            $sql = "SELECT balance_history.*, registration_user.Fname, registration_user.Lname, registration_user.email FROM balance_history LEFT JOIN registration_user ON balance_history.user_id = registration_user.id  WHERE registration_user.id = ".$userData['id']." ORDER BY balance_history.id DESC";
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body table-responsive">
            <table class="table table-hover" id="table_registration_User_1">
                ...
                <tbody>
                <?php               
            $sql="SELECT balance_history.*, registration_user.Fname, registration_user.Lname, registration_user.email FROM balance_history LEFT JOIN registration_user ON balance_history.user_id = registration_user.id WHERE balance_history.balance_Status = 'Withdraw' AND registration_user.id = ".$userData['id']." ORDER BY balance_history.id DESC";
            $querry= mysqli_query($con,$sql);
            $row=mysqli_num_rows($querry);
            if( $row)
            {
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body table-responsive">
            <table class="table table-hover" id="table_registration_User_2">
                ...
                <tbody>
                <?php               
            $sql="SELECT balance_history.*, registration_user.Fname, registration_user.Lname, registration_user.email FROM balance_history LEFT JOIN registration_user ON balance_history.user_id = registration_user.id WHERE balance_history.balance_Status = 'Deposit' AND registration_user.id = ".$userData['id']." ORDER BY balance_history.id DESC";
            $querry= mysqli_query($con,$sql);
            $row=mysqli_num_rows($querry);
            if( $row)
            {
