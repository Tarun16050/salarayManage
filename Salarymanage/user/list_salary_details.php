    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body table-responsive">
            <table class="table table-hover" id="table_registration_User">
                ...
                <tbody>
                <?php               
            $sql="SELECT * FROM `salary` WHERE `user_id` =".$userData['id']."";
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body table-responsive">
            <table class="table table-hover" id="table_registration_User_1">
                ...
                <tbody>
                <?php               
            $sql="SELECT COUNT(salary.id) AS total_salary_ids, SUM(salary.amount) AS total_salary_amount, registration_user.* FROM registration_user LEFT JOIN salary ON registration_user.id = salary.user_id WHERE registration_user.id = ".$userData['id']." GROUP BY registration_user.id";
            $querry= mysqli_query($con,$sql);
            $row=mysqli_num_rows($querry);
            if( $row)
            {
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body table-responsive">
            <table class="table table-hover" id="table_registration_User_2">
                ...
                <tbody>
                <?php               
            $sql="SELECT registration_user.id AS user_id, COUNT(salary.id) AS total_salary_ids, SUM(salary.amount) AS total_salary_amount, salary.salary_year AS salary_year, registration_user.* FROM registration_user LEFT JOIN salary ON registration_user.id = salary.user_id WHERE registration_user.id = ".$userData['id']." GROUP BY registration_user.id, salary_year";
            $querry= mysqli_query($con,$sql);
            $row=mysqli_num_rows($querry);
            if( $row)
            {
