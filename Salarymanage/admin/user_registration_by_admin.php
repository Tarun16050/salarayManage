...
<?php
 $update_id = $_GET["id"];
 $sql  ="SELECT * FROM registration_user WHERE `id`={$update_id}";
        ...
        <form action="" method="post" enctype="multipart/form-data" id="admin_form">
            ...
            <div class="user-details">
              ...
              <div class="input-box">
                ...
                <input type="text" placeholder="Confirm your password"  name="cpsw" id="confirm_Password" value="<?= $arrdata['password'] ?>">
...
{   $error = [];
    ...
    $opt='Select Option'; 
    if(empty($error)){    
        $ins="UPDATE `registration_user` SET `id`='$ids',`Fname`='$fname',`Lname`='$lname',`mobile`='$mobile',`email`='$email' WHERE `id`={$ids}";
